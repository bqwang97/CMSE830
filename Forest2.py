 ...
 * Spatial Coordinates: X and Y axis spatial coordinates within the park.
 * Time Factors: Month and day of the week
 * Fire weather Index System Parameters: Include FFMC, DMC, DC and ISI indices.
 * Meteorological Data: Temperature (in Celsius), relative humidity (%), wind speed (km/h), and outside rain (mm/m^2).
 * Outcome Variable: Burned area of the forest (in ha). </p>', unsafe_allow_html=True)
